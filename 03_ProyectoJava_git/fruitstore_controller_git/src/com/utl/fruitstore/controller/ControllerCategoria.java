...
public class ControllerCategoria {
     ...
     *
     * @param g Es un objeto de tipo Grupo con los valores en los atributos correspondientes.
     * @return Devuelve el ID del grupo que se genero al realizar la insercion.
     * @throws Exception Se lanza una excepcion cuando ocurre un fallo en la comunicacion con la Base de Datos o se altero de forma erronea una
     * sentencia SQL.
     */
     ...
     *
     * @param g Es un objeto de tipo Grupo con todos los datos que van a actualizarse.
     * @throws Exception Se lanza una excepcion cuando ocurre un fallo en la comunicacion con la Base de Datos o se altero de forma erronea una
     * sentencia SQL.
     */
    ...
    /**
     * Elimina de forma logica el registro de la tabla [grupo] correspondiente al valor del identificador (ID) pasado como parametro.
     *
     ...
     *
     * @param filtro Un valor que sera buscado por coincidencia parcial en todos los campos de la vista que contiene los registros de grupos.
     * @return Devuelve una lista <code>List&lt;Grupo&gt;</code> que contiene todos los registros encontrados en la BD.
     * @throws Exception
     */
     ...
     * los datos de la posicion en la que se encuentra el <i>cursor</i> del      <code>ResultSet<code> pasado como parametro.
     *
     * @param rs
     * @return
     * @throws Exception
